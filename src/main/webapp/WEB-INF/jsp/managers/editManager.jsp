...
<petclinic:layout pageName="managers">
    <h2>Managers</h2>
    <form:form modelAttribute="manager" class="form-horizontal" id="add-manager-form" action="/managers/save">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                <button class="btn btn-default" type="submit">Anadir manager</button>
