...
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (6,4,'Mantequilla', 5.0, 15.0, 20.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (7,1,'Carne Picada', 1.0, 1.5, 4.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (8,6,'Tomate Frito', 5.0, 18.0, 20.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (9,3,'Cebolla', 5.0, 1.5, 4.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (10,6,'Nata', 4.0, 9.0, 15.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (11,6,'Arroz', 1.0, 5.5, 10.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (12,3,'Tomate', 1.0, 2.0, 4.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (13,6,'Huevos', 12.0, 18.0, 36.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (14,3,'Patatas', 1.0, 3.0, 5.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (15,6,'Aceite', 0.5, 1.0, 10.0, 3);
INSERT INTO producto(id,tipo_producto,name,cantidad_minima,cantidad_actual,cantidad_maxima,proveedor_id) VALUES (16,4,'Roque', 1.0, 4.0, 4.0, 3);

--PLATOS--
INSERT INTO platos(id,name,precio,disponible) VALUES (1, 'Albóndigas',4, TRUE);
INSERT INTO platos(id,name,precio,disponible) VALUES (2, 'Revuelto de bacalao',4, TRUE);
INSERT INTO platos(id,name,precio,disponible) VALUES (3, 'Solomillo al roque',4, FALSE);
INSERT INTO platos(id,name,precio,disponible) VALUES (4, 'Arroz a la cubana',4, TRUE);
INSERT INTO platos(id,name,precio,disponible) VALUES (5, 'Tortilla de patatas',4, TRUE);
...
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (2,2,3,1);
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (3,2,3,1);
				--Revuelto de bacalao--
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (4,2,3,1);
				--Albóndigas--
				--Albóndigas--
				--Albóndigas--
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (5,2,3,1);
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (6,2,3,1);
INSERT INTO ingrediente(id,cantidad,producto_id,plato_id) VALUES (7,3,6,1);
...
INSERT INTO comanda(id, mesa, fecha_creado, fecha_finalizado, precio_total, camarero_id) VALUES (1,2,'2020-12-10 14:56:17','2020-12-11 14:56:17',15,1);
INSERT INTO comanda(id, mesa, fecha_creado, fecha_finalizado, precio_total, camarero_id) VALUES (2,3,'2020-12-12 14:56:17','2020-12-14 14:56:17',15,1);
